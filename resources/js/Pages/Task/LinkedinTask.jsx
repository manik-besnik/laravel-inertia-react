...
const LinkedinTask = ({account}) => {
    ...
    return (
        <>
            <Head title="Create Linkedin Task | Maketop.me"/>

            <AuthenticatedLayout
                user={auth.user}
                header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Linkedin</h2>}
            >
                        ...
                        <form onSubmit={handleSubmit} className='max-w-[454px]'>
                            ...
                            {!account && <div
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className='text-xs leading-[14px] sm:text-sm text-white'>Add Your Linkedin Profile URL First!</span>
                                </div>
                            </div>}
