...
const BehanceTask = ({account}) => {
    ...
    return (
        <>
            <Head title="Create Behance Task | Maketop.me"/>
            ...
            >
                ...
                <div className='flex justify-between gap-20 flex-col min-h-screen'>
                    <div>
                        ...
                        <h2 className='app-subtitle'>Create Task for Behance:</h2>
                        ...
                        <div className="flex items-center justify-start gap-[10px] mb-[30px]">

                            {
                                tabs.map((tab, idx) => (
                                    <Link key={idx}
                                          href={tab.isComing ? '' : route('behance.create', {type: tab.typeOfTask})}
                        ...
                        <form onSubmit={handleSubmit} className='max-w-[454px]'>
                            ...
                            {!account && <div
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className='text-xs leading-[14px] sm:text-sm text-white'>Add Your Behance Profile URL First!</span>
                                </div>
                            </div>}
