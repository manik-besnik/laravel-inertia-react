...
const DribbbleTask = ({account}) => {
    ...
    const {data, setData, errors, post, progress, processing} = useForm({
        account_type: accountType.dribbble,
    ...
    return (
        <>
            <Head title="Create Dribbble Task | Maketop.me"/>

            <AuthenticatedLayout
                header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Dribbble</h2>}
            >
                ...
                <div className='flex justify-between gap-20 flex-col min-h-screen'>
                    <div>
                        ...
                        <h2 className='app-subtitle'>Create Task for Dribbble:</h2>
                        ...
                        <form onSubmit={handleSubmit} className='max-w-[454px]'>
                            <div className='mb-4 sm:mb-6'>
                                ...
                                <InputBox
                                    value={data.task_url}
                                    disabled={data.task_type === data.task_type === taskType.follow}
                            ...
                            {!account && <div
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className='text-xs leading-[14px] sm:text-sm text-white'>Add Your Dribbble Profile URL First!</span>
                                </div>
                            </div>}
