...
const FacebookTask = ({account}) => {
    ...
    return (
        <>
            <Head title="Create Facebook Task | Maketop.me"/>

            <AuthenticatedLayout
                header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Facebook</h2>}
            >
                        ...
                        <form onSubmit={handleSubmit} className='max-w-[454px]'>
                            ...
                            {!account && <div
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className='text-xs leading-[14px] sm:text-sm text-white'>Add Your Facebook Profile URL First!</span>
                                </div>
                            </div>}
